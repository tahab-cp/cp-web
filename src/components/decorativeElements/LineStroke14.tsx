...
const LineStroke14 = (props: React.SVGProps<SVGSVGElement>) => {
    ...
    if (pathRef.current && svgRef.current) {
      ...
      gsap.to(pathRef.current, {
        ...
        scrollTrigger: {
          ...
          start: "top 80%  bottom", // when SVG enters bottom of viewport
  ...
  return (
    ...
    >
      <path
        ...
        stroke="url(#paint0_linear_171_577)"
        strokeWidth="36"
        strokeLinecap="round"
      />
      <defs>
        <linearGradient
          id="paint0_linear_171_577"
          x1="1471"
          y1="34.2623"
          x2="268.912"
          y2="714.859"
